...
@SpringBootTest
public class ItemDescFetcherTestSpring {
    private static final Logger log = LoggerFactory.getLogger(ItemDescFetcherTestSpring.class);
    ...
    public void getInfo() {
        ...
        parseRawFromDB().map(rd -> rd.itemId).drop(3800)
                .forEach(id -> {
